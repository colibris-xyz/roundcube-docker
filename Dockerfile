...
COPY config/config.custom.inc.php /var/roundcube/config/config.custom.inc.php
COPY config/config.html5notifier.inc.php /var/roundcube/config/config.html5notifier.inc.php
